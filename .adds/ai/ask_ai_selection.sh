...
DEFAULT_PROMPT_TEMPLATE="/mnt/onboard/.adds/ai/prompt_template.tmpl"

OUT_DIR="/mnt/onboard/.adds/ai/output"
WORK_DIR="/mnt/onboard/.adds/ai/tmp"
LOG_DIR="/mnt/onboard/.adds/ai/logs"

LOG="$LOG_DIR/ai_activity.log"
PROMPT_FILE="$WORK_DIR/selection_prompt.tmp"
JSON_FILE="$WORK_DIR/request.json"
RAW_FILE="$WORK_DIR/raw_response.json"
RESPONSE_TEXT_FILE="$WORK_DIR/response_text.tmp"
STATUS_FILE="$WORK_DIR/current_status.state"
ESCAPE_HTML_PY="$WORK_DIR/escape_html.py"
HTTP_CODE_FILE="$WORK_DIR/http_code.code"
CURL_ERR_FILE="$WORK_DIR/curl_stderr.log"
CURL_BIN=""
